...
type HtmlElt = { getElementsByTagName :: String -> Array {  value :: String
...
foreign import queryEmails_ :: forall eff . HtmlElt -> Eff (dom :: DOM | eff) Foreign


-- << It uses queryEmails_ so that we can provide a mock for Testing
readEmails_ :: forall eff . HtmlElt
